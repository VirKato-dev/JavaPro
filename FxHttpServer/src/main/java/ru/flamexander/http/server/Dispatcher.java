...
import ru.flamexander.http.server.processors.ResponseProcessor;
...
public class Dispatcher {
    ...
    public void execute(HttpRequest httpRequest, OutputStream outputStream) throws IOException {
        try {
            ...
            if (Files.exists(Paths.get(DefaultStaticResourcesProcessor.RESOURCES + "static", httpRequest.getUri()))
                    && !httpRequest.getUri().substring(1).equals("")) {
